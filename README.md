...
- [1. Работа со скриптами и взаимодействие между объектами](##Результат-1)

# 1. Работа со скриптами и взаимодействие между объектами

## Результат можно посмотреть чуть ниже или [тут](#1-работа-со-скриптами-и-взаимодействие-между-объектами).
